        ...
        for episode in range(nb_episodes):
            ...
            while not done:
                ...
                if 'aleatoric_std_dev' in action_info:
                    mean_aleatoric_std_dev_chosen_action = mean_aleatoric_std_dev_chosen_action + \
                                                           (action_info['aleatoric_std_dev'][action] -
                                                            mean_aleatoric_std_dev_chosen_action) / \
                                                           np.sum(total_actions)
                ...
                if 'epistemic_std_dev' in action_info:
                    mean_epistemic_std_dev_chosen_action = mean_epistemic_std_dev_chosen_action + \
                                                           (action_info['epistemic_std_dev'][action] -
                                                            mean_epistemic_std_dev_chosen_action) / \
                                                           np.sum(total_actions)
