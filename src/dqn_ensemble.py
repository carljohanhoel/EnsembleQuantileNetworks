...
class AbstractDQNAgent(Agent):
    ...
    def __init__(self, nb_actions, memory, gamma, batch_size, nb_steps_warmup, train_interval, memory_interval,
...
class DQNAgentEnsemble(AbstractDQNAgent):
    ...
    def __init__(self, models, policy, test_policy, enable_double_dqn, *args, **kwargs):
...
class DQNAgentEnsembleParallel(AbstractDQNAgent):
    ...
    # Args
        nb_models (int): Size of ensemble
        ...
        policy: Policy of the agent during the training process.
        test_policy: Policy of the agent during the testing phase.
        enable_double_dqn (bool): True if double DQN is used, otherwise false
        enable_dueling_network (bool): Use dueling architecture.
    """

    def __init__(self, nb_models, cnn_architecture, learning_rate, nb_ego_states, nb_states_per_vehicle, nb_vehicles,
